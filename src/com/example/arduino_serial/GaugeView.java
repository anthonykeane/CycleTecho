...
public class GaugeView extends View {
    ...
    public static final float OUTER_SHADOW_WIDTH = 0.01f;
    public static final float OUTER_BORDER_WIDTH = 0.01f;
    public static final float OUTER_RIM_WIDTH = 0.02f;
    public static final float INNER_RIM_WIDTH = 0.02f;
    public static final float INNER_RIM_BORDER_WIDTH = 0.005f;

    public static final float NEEDLE_WIDTH = 0.020f;
    public static final float NEEDLE_HEIGHT = 0.40f;
    ...
    public static final int SCALE_SUBDIVISIONS = 10;
    ...
    public static final float[] RANGE_VALUES = {30.0f, 45.0f, 55.0f, 600.0f};
    public static final int[] RANGE_COLORS = {Color.WHITE, Color.WHITE, Color.WHITE,Color.WHITE};

    public static final int TEXT_SHADOW_COLOR = Color.argb(100, 0, 0, 0);
    public static final int TEXT_VALUE_COLOR = Color.WHITE;
    public static final int TEXT_UNIT_COLOR = Color.DKGRAY;
    public static final float TEXT_VALUE_SIZE = 0.15f;
...
//                Color.rgb(27, 59, 131)}, new float[]{0.5f, 0.96f, 0.99f}, Shader.TileMode.MIRROR));
    ...
    private void drawText(final Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(mTextUnit)) {
            canvas.drawText(mTextUnit, CENTER , CENTER - 0.12f, mTextUnitPaint);
        }
    }
